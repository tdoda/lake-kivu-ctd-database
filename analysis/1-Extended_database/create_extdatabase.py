# -*- coding: utf-8 -*-
"""
Create an extended database from grid of profiles
...
import math
import cmocean
from ctd_extdatabase import ctd_extdatabase
...
data_files = ["L3_REMA.nc", "L3_KW.nc"]
...
output_files=["database_REMA_"+str(dmin)+"m.nc","database_Kivuwatt_"+str(dmin)+"m.nc"]
databases_all=[]
#%% Load hypsometry
...
# Save netCDF   
database_comb.to_netcdf("extdatabase_combined_"+str(dmin)+"m.nc")

...
databases_all=[]
#%% Load hypsometry
df_hypso=pd.read_csv(hypsometry_file,sep='\t',index_col=False,names=['z','area'],skiprows=1) 
...
database_periods_comb.to_netcdf("database_combined_"+str(dmin)+"m_periods.nc")
